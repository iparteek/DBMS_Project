...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Admin Main Page |  Mini Project">
    ...
    <div class="logo-container">
        ...
        <?php 
            ...
            if (isset($_SESSION['login_user'])) {
                ...
                INNER JOIN mhtcet_details J         ON S.id = J.id
                ...
                <tr>
                    ...
                    <th colspan='8'>MHTCET Details</th>
                ...
                <tr>
                    <th colspan='15'></th>
                    <th colspan='8'></th>
                    <th colspan='3'>MHTCET 2024 Counselling</th>
                ...
                while($data = mysqli_fetch_array($result))
                {
                    ...
                    echo "<td>" . $data['MHTCET-round'] . "</td>";
                    echo "<td>" . $data['MHTCET-roll'] . "</td>";
                    echo "<td>" . $data['MHTCET-rank'] . "</td>";
                    echo "<td>" . $data['MHTCET-mark'] . "</td>";
                    echo "<td>" . $data['MHTCET-score'] . "</td>";
                    echo "<td>" . $data['MHTCET-year'] . "</td>";
...
//  echo "<td><form action='php/edit.php' method='post'>
//          <input type='hidden' name='id' value='" . $data['id'] . "'>
//          <button type='submit'>Update</button>
//        </form></td>";

                      echo "<td><a href='php/delete.php?id=" . $data['id'] . "' class='delete-button'>Delete</a></td>";
                    
                      echo "<td><a href='php/edit.php?id=" . $data['id'] . "' class='update-button'>UPDATE</a></td>";
