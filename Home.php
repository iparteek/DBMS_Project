...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Student Admission Webportal | Mini Project">
    ...
    <body>
        ...
        <main class="container">
            <p>Fill this application to apply for an admission in RMDSTIC BE Programme.</p>
            ...
            <form action="php/feedback.php" method="POST" class="admission-form">
                <div class="student-details">
                    ...
                    <br><br>
                    <label>Mobile No 1
                        <input type="number" name="mob1" id="mob1" maxlength="10">
                    </label>
                    <br><br>
                    <label>Mobile No 2
                        <input type="number" name="mob2" id="mob2" maxlength="10">
                    </label>
                    <br><br>
                    <label>Email
                    ...
                    <label>Aadhaar Number
                        <input type="number" name="aadhar" id="aadhar" maxlength="12">
                    </label>
                    <br><br>
                    <label>Father's Name
                ...
                <div class="mhtcet-details">
                    <h3>MHTCET Details</h3>
                    <label>Round of Allotment
                        <input type="text" name="MHTCET-round" id="MHTCET-round">
                    </label>
                    <br><br>
                    <label>MHTCET Roll No
                        <input type="text" name="MHTCET-roll" id="MHTCET-roll">
                    </label>
                    <br><br>
                    <label>MHTCET AIR
                        <input type="text" name="MHTCET-rank" id="MHTCET-rank">
                    </label>
                    <br><br>
                    <label>MHTCET Mark
                        <input type="text" name="MHTCET-mark" id="MHTCET-mark">
                    </label>
                    <br><br>
                    <label>MHTCET Score
                        <input type="text" name="MHTCET-score" id="MHTCET-score">
                    </label>
                    <br><br>
                    <label>MHTCET Year
                        <input type="text" name="MHTCET-year" id="MHTCET-year">
                    </label>
                    <br><br>
                ...
                <div class="declaration-details">
                    ...
                    <form method="post" action="process_form.php">
                            ...
                            <input type="checkbox" name="options[]" id="option1" value="Option 1">
                            <br>
                            <br><br>
                    <label>Date
                   ...
                   <!-- <label>Signature of Applicant
                    ...
                    <label for="sign" class="upload-label">
                        <span>Signature of Applicant</span>
                        <input type="file" name="sign" id="sign" class="file-input">
                    </label>
